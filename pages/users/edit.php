      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
              <!-- /.card-header -->
              <!-- form start -->
              <form action="functions/users/update.php" class="form-horizontal" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-10 mt-1">
                      <div class="form-check-inline mr-4">
                        <input class="form-check-input" type="radio" id="admin" name="role" value="admin" <?= $user['role'] == 'admin' ? 'checked' : '' ?>>
                        <label for="admin" class="form-check-label">Admin</label>
                      </div>
                      <div class="form-check-inline mr-4">
                        <input class="form-check-input" type="radio" id="teknisi" name="role" value="teknisi" <?= $user['role'] == 'teknisi' ? 'checked' : '' ?>>
                        <label for="teknisi" class="form-check-label">Teknisi</label>
                      </div>
                      <div class="form-check-inline mr-4">
                        <input class="form-check-input" type="radio" id="user" name="role" value="user" <?= $user['role'] == 'user' ? 'checked' : '' ?>>
